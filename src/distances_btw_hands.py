...
def dist_btw_hands(hand1, hand2):
    return math.sqrt((hand1[0] - hand2[0])**2 + (hand1[1] - hand2[1])**2)

def prepare_data(item, hist_features):
    dist_features = dist_btw_hands(item['pose']['pose'][50], item['pose']['pose'][51])
...
if __name__ == "__main__":
    if len(sys.argv) < 3:
        ...
        paint_hist(hist_features_1, hist_features_2, "Comparación de distancias entre manos", json_file_1, json_file_2)
